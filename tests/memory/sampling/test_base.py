...
class TestSampling(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.sampling = BaseSampling(replay_memory=self.replay_memory, model=self.model,
    ...
    def test_create_model_input(self):
        model_input, model_output = self.sampling.random_batch(32)
    ...
    def _get_batch(self, batch_size):
        """  Return fake states, actions, rewards, done, next_state.  """
